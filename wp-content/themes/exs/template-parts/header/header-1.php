...
<div id="header-affix-wrap" class="header-wrap <?php echo esc_attr( $exs_header_background . ' ' . $exs_transparent . ' ' . $exs_absolute ); ?>">
	...
	<header id="header"
			...
			class="header header-1 <?php echo esc_attr( $exs_header_background . ' ' . $exs_font_size . ' ' . $exs_header_align_main_menu . ' ' . $exs_sticky . ' ' . $exs_transparent . ' ' . $exs_absolute . ' ' . $exs_header_top_tall . ' ' . $exs_header_has_menu_class ); ?> style="direction: rtl;">
		<?php
